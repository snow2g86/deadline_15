Object.assign(G, {
	...
	doHeal(h, t) {
		const amt = Math.round(h.atk * 1.5); const he = this._grantExp(h, 'heal'); t.hp = Math.min(t.mhp, t.hp + amt); this.vfxHeal(t); this.vfxBuff(t); this.sfxHeal(); this.floatT(t.x, t.y, `+${amt}`, 'heal');
